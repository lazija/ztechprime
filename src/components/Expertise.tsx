...
export function Expertise() {
  ...
  return (
    <section id={expertise.id} className="scroll-mt-28 bg-paper px-5 py-20 md:scroll-mt-24 md:px-10 md:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-px bg-navy/10 sm:grid-cols-2">
          {expertise.services.map((service) => (
            <article key={service.title} className="bg-paper px-6 py-8 md:px-8 md:py-10">
